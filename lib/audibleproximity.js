...
function updateAudioPlayback(instance) {
  ...
  // First loop: update already matched players
  ...
  // Second loop: update unmatched players
...
function updatePlayers(players, audibleDevice) {
  ...
  players.forEach((player, index) => {
    if(player.file === audibleDevice.file) {
      playerIndex = index;
      player.instance.volume(audibleDevice.targetVolume); // TODO: increment
      player.volume = audibleDevice.targetVolume;         // TODO: increment
