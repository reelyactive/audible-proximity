...
/**
 * PiAudibleProximity Class
 * Programatically play audio files on a Raspberry Pi based on its proximity to
 * Bluetooth beacons.
 */
class PiAudibleProximity {

  /**
   * PiAudibleProximity constructor
 ...
 * @param {PiAudibleProximity} instance The PiAudibleProximity instance.
...
module.exports = PiAudibleProximity;
